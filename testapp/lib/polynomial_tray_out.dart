...
class PolyTrayOut extends StatelessWidget {
...
class _MyHomePageState extends State<_MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var v = new List.generate(10, (_) => new List(2));
    int j1 = 0;
    if (cow == 0) {
      for (double i = 0; i <= cxn; i = i + cxn / 9) {
        v[j1][0] = i;
        v[j1][1] = aw * i * i * i + bw * i * i + cw * i + dw;
        j1++;
      }
    } else if (cow == 2) {
      for (double i = 0; i <= cxn; i = i + cxn / 9) {
